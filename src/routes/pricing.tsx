...
const plans: Plan[] = [
  ...
  },
  {
    ...
    cta: "Contacter",
    featured: false,
    href: "mailto:contact@mafiche.be?subject=Demande%20offre%20Pro",
    external: true,
  },
];
    ...
    <div className="min-h-screen bg-bg text-ink">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="grid md:grid-cols-3 gap-6">
          {plans.map((p) => {
            const btnClass = `mt-6 w-full inline-flex items-center justify-center px-4 py-3 rounded-md font-bold text-sm transition-all ${
              p.featured
            ...
            return (
              ...
              >
                ...
                {p.external ? (
                  <a href={p.href} className={btnClass} style={btnStyle}>
                    {p.cta}
                  </a>
                ) : (
                  <Link to={p.href} className={btnClass} style={btnStyle}>
                    {p.cta}
                  </Link>
                )}
